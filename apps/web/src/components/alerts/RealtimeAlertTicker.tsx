...
export const RealtimeAlertTicker: React.FC = () => {
  ...
  return (
    <>
      <div
        className={`w-full text-xs font-medium border-b transition-colors shadow-xs ${
          criticalCount > 0
            ? "bg-gradient-to-r from-rose-700 via-rose-600 to-rose-700 text-white border-rose-800"
            : highCount > 0
            ? "bg-gradient-to-r from-amber-600 via-amber-500 to-amber-600 text-white border-amber-700"
            : "bg-slate-800 text-slate-200 border-slate-700"
        }`}
      >
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-2 flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
          ...
          <div className="flex items-center gap-2 shrink-0 justify-end flex-wrap">
            ...
            {latest && (
              <button
                ...
                className="px-2.5 py-1 rounded-lg bg-white/20 hover:bg-white/30 text-white font-bold text-[11px] transition-colors flex items-center gap-1 shadow-2xs"
              >
            ...
            {latest && (
              <button
                ...
                className="px-2.5 py-1 rounded-lg bg-white text-slate-900 hover:bg-slate-100 font-bold text-[11px] transition-all flex items-center gap-1 shadow-xs disabled:opacity-50"
              >
